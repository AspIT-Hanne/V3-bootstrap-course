    ...
    <article class="col accordion">
        <div class="card">
            <div class="card-header" id="HeadingLab">
                <!-- <h2> -->
                    <button class="btn btn-link text-decoration-none text-secondary text-uppercase" type="button" data-toggle="collapse" data-target="#ContentLab">
                        In-House Diagnostic Lab
                    </button>
                <!-- </h2> -->
            </div>
            <div id="ContentLab" class="collapse">
                <div class="card-body">
        ...
        <div class="card">
            <div class="card-header" id="HeadingRadio">
                <h2>
                    <button class="btn btn-link text-decoration-none text-secondary text-uppercase" type="button" data-toggle="collapse" data-target="#ContentRadio">
                        Digital Radiography
                    </button>
                </h2>
            </div>
            <div id="ContentRadio" class="collapse">
                <div class="card-body">
        ...
        <div class="card">
            <div class="card-header" id="HeadingEKG">
                <h2>
                    <button class="btn btn-link text-decoration-none text-secondary text-uppercase" type="button" data-toggle="collapse" data-target="#ContentEKG">
                        EKG
                    </button>
                </h2>
            </div>
            <div id="ContentEKG" class="collapse">
                <div class="card-body">
        ...
        <div class="card">
            <div class="card-header" id="HeadingUltra">
                <h2>
                    <button class="btn btn-link text-decoration-none text-secondary text-uppercase" type="button" data-toggle="collapse" data-target="#ContentUltra">
                        Ultrasound
                    </button>
                </h2>
            </div>
            <div id="ContentUltra" class="collapse">
                <div class="card-body">
